...
class Matalheads extends StatefulWidget {
  const Matalheads({Key? key}) : super(key: key);

  @override
  State<Matalheads> createState() => _MatalheadsState();
}

class _MatalheadsState extends State<Matalheads> {
  @override
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image:
                              AssetImage("assets/other-image/bed mattress.png"),
                          fit: BoxFit.cover)),
                ),
              ),
            ),
