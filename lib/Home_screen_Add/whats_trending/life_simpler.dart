...
class Life_Simpler extends StatefulWidget {
  const Life_Simpler({Key? key}) : super(key: key);

  @override
  State<Life_Simpler> createState() => _Life_SimplerState();
}

class _Life_SimplerState extends State<Life_Simpler> {
  @override
