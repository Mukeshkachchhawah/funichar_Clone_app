...
class Explor_Industral extends StatefulWidget {
  const Explor_Industral({Key? key}) : super(key: key);

  @override
  State<Explor_Industral> createState() => _Explor_IndustralState();
}

class _Explor_IndustralState extends State<Explor_Industral> {
  @override
