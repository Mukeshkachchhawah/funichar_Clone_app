...
class Explor_Contemporary extends StatefulWidget {
  const Explor_Contemporary({Key? key}) : super(key: key);

  @override
  State<Explor_Contemporary> createState() => _Explor_ContemporaryState();
}

class _Explor_ContemporaryState extends State<Explor_Contemporary> {
  @override
