...
class Shop_Study_Room extends StatefulWidget {
  const Shop_Study_Room({Key? key}) : super(key: key);

  @override
  State<Shop_Study_Room> createState() => _Shop_Study_RoomState();
}

class _Shop_Study_RoomState extends State<Shop_Study_Room> {
  @override
